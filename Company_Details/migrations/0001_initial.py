    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Observer', 'Observer'), ('Coordinator', 'Coordinator'), ('Hod', 'Hod')], default='Hod', max_length=50)),
                ...
                ('company_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Company_Details.company')),
